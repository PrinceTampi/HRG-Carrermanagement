        ...
        <div class="daw-recruitment__tracking-container">
            ...
            <?php else : ?>
                ...
                <section class="daw-recruitment__tracking-card daw-recruitment__tracking-current">
                    <div class="daw-recruitment__tracking-current-head"><div><span class="daw-recruitment__tracking-label">Tahap Saat Ini</span><h2><span aria-hidden="true">●</span> Tes Psikologi</h2></div><span class="daw-recruitment__tracking-running"><?= 'offline' === $psychology_method ? 'Terjadwal' : 'Sedang berlangsung' ?></span></div>
