...
$stage_label = 'Diterima';
$stage_status = 'Diterima';
$next_stage = 'Onboarding';
$next_description = 'Selamat! Tim HR telah menyetujui lamaran Anda dan akan menginformasikan tahapan onboarding serta jadwal onboarding berikutnya.';
$timeline = [
    ...
    [ 'label' => 'Keputusan Akhir', 'date' => '30 Agustus 2026', 'state' => 'current', 'state_label' => 'Diterima' ],
];
?>
    ...
    <main class="daw-recruitment__tracking-main">
        <div class="daw-recruitment__tracking-container">
            ...
            <section class="daw-recruitment__tracking-card daw-recruitment__tracking-current">
                ...
                <p>Selamat! Anda dinyatakan lolos dan diterima pada proses rekrutmen untuk jabatan Sales Consultant.</p>
                <span class="daw-recruitment__tracking-notice">◷ Tim HR akan segera menghubungi Anda untuk proses onboarding dan penempatan kerja.</span>
                <div class="daw-recruitment__tracking-availability"><strong>Keputusan Akhir</strong><span>Anda diterima dan akan masuk ke tahap onboarding selanjutnya.</span></div>
            </section>
