...
$stage_label = 'Wawancara User';
$stage_status = 'Jadwal Ditetapkan';
$next_stage = 'Keputusan Akhir';
$next_description = 'Setelah wawancara user selesai, tim akan melakukan evaluasi akhir danmemberikan keputusan hasil seleksi.';
$timeline = [
    ...
    [ 'label' => 'Wawancara User', 'date' => '29 Agustus 2026', 'state' => 'current', 'state_label' => 'Jadwal Ditetapkan' ],
    ...
    <main class="daw-recruitment__tracking-main">
        <div class="daw-recruitment__tracking-container">
            ...
            <section class="daw-recruitment__tracking-card daw-recruitment__tracking-current">
                ...
                <p>Wawancara dengan user akan menilai kesesuaian kompetensi, budaya kerja, dan kebutuhan operasional di unit kerja terkait.</p>
                <span class="daw-recruitment__tracking-notice">◷ Persiapkan diri untuk sesi tanya jawab dan diskusi mengenai posisi yang dilamar.</span>
                <div class="daw-recruitment__tracking-availability"><strong>Jadwal Interview</strong><span>29 Agustus 2026 — 13:30 WITA</span></div>
            </section>
