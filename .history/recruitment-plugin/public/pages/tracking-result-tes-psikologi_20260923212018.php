...
$stage_label = 'Tes Psikologi';
$stage_status = 'Sedang Berlangsung';
$next_stage = 'Wawancara HR';
$next_description = 'Setelah selesai, hasil tes akan divalidasi oleh tim HR dan dilanjutkan ke tahap wawancara berikutnya.';
$timeline = [
    ...
    [ 'label' => 'Tes Psikologi', 'date' => '25 Agustus 2026', 'state' => 'current', 'state_label' => 'Sedang Berlangsung' ],
    ...
    <main class="daw-recruitment__tracking-main">
        <div class="daw-recruitment__tracking-container">
            ...
            <section class="daw-recruitment__tracking-card daw-recruitment__tracking-current">
                ...
                <div class="daw-recruitment__tracking-availability"><strong>Tes Psikologi Anda Sudah Tersedia</strong><span>Tes dapat dilakukan mulai 25 Agustus 2026 — 08:00 WITA</span></div>
