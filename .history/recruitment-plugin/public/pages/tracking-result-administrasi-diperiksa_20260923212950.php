...
$stage_status = 'Sedang Diperiksa';
$next_stage = 'Pengumuman Seleksi Administrasi';
$next_description = 'Tim HR sedang meninjau kelengkapan dokumen dan kualifikasi administrasi Anda. Pengumuman lanjutan akan segera diinformasikan.';
$timeline = [
    [ 'label' => 'Lamaran Dikirim', 'date' => '22 Agustus 2026', 'state' => 'done', 'state_label' => 'Selesai' ],
    [ 'label' => 'Seleksi Administrasi', 'date' => '23 Agustus 2026', 'state' => 'current', 'state_label' => 'Sedang Diperiksa' ],
    ...
    <main class="daw-recruitment__tracking-main">
        <div class="daw-recruitment__tracking-container">
            ...
            <section class="daw-recruitment__tracking-card daw-recruitment__tracking-current">
                ...
                <p>Dokumen dan berkas lamaran Anda sedang dilakukan pengecekan oleh tim HR.</p>
                <span class="daw-recruitment__tracking-notice">◷ Mohon menunggu pengumuman selanjutnya dari tim rekrutmen.</span>
                <div class="daw-recruitment__tracking-availability">
                    <strong>Informasi Tambahan</strong>
                    <span>Jika ada dokumen yang perlu dilengkapi, tim akan menghubungi Anda lewat email atau nomor kontak yang terdaftar.</span>
                </div>
            </section>
