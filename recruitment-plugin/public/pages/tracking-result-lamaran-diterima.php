...
$stage_label = 'Lamaran Diterima';
$stage_status = 'Diterima';
$next_stage = 'Seleksi Administrasi';
$next_description = 'Tim HR sedang meninjau berkas lamaran Anda dan akan menghubungi jika ada dokumen tambahan yang perlu dilengkapi.';
$timeline = [
    ...
    <main class="daw-recruitment__tracking-main">
        <div class="daw-recruitment__tracking-container">
            ...
            <section class="daw-recruitment__tracking-card daw-recruitment__tracking-current">
                ...
                <p>Lamaran Anda telah masuk ke sistem dan telah diterima oleh tim rekrutmen untuk proses selanjutnya.</p>
                <span class="daw-recruitment__tracking-notice">◷ Dokumen yang dikirim sudah sesuai dengan persyaratan awal.</span>
                <div class="daw-recruitment__tracking-availability"><strong>Catatan Tim HR</strong><span>Tim HR sedang memverifikasi kelengkapan berkas dan kualifikasi kandidat.</span></div>
            </section>
